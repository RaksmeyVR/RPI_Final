Public Class frm_degree
    ...
    '    Label_Description.ForeColor = ThemeColor.PrimaryColor
    '    DataGridView.BackgroundColor = ThemeColor.SecondaryColor
    'End Sub
    Private Sub frm_degree_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'LoadTheme()
        LoadGrid()
        headdvg()
        autoid()
...
#Region "Save data in form"
    Private Sub Insert()
        ...
        sql.ExecQuery("INSERT INTO tbl_degree " &
    ...
    Private Sub Update()
        ...
        sql.ExecQuery("Update tbl_degree SET nameKH= @nameKH,nameEN = @nameEN,description = @description WHERE id=@id")
    ...
    Private Sub Delete()
        If MsgBox("តើអ្នកប្រាកដទេថាចង់លុបទិន្នន័យនេះ !?", MsgBoxStyle.YesNo, "លុបទិនន្នន័យ?") = MsgBoxResult.Yes Then
            ...
            sql.AddParam("@id", txtID.Text)
            DelString += "DELETE FROM tbl_degree WHERE id=@id ;"
...
#Region "Retreive Data in Form"
    ...
    Sub headdvg()
        ...
        DGV_Data.Columns(1).HeaderText = "កម្រិតសិក្សា"
...
#End Region
    ...
    Sub autoid()
        ...
        txtID.Text = sql.getMaxID("tbl_degree", "id", "DG-000", 4, 4)
    End Sub
    ...
    Private Sub TextalertInsert()
        ...
        If txtNameKH.Text = "" Then
            MessageBox.Show("សូមបញ្ចូលកម្រិតសិក្សា")
            txtNameKH.Focus()
